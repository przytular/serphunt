...
class SearchViewSet(viewsets.GenericViewSet,
	...
	def create(self, request, *args, **kwargs):
		...
		# Check if SERP request already exists under time limit. Return it, if match.
		sr = SearchResults.objects.filter(keyword=keyword, user=request.user if request.user.is_authenticated else None)
		sr = sr.first()
